...
@Entity
@Audited
@Table(name = "bank_fixed_incomes_balance")
public class BankFixedIncomesBalanceEntity extends BaseEntity{
    @Id
    @GeneratedValue
    ...
    public ResponseBankFixedIncomesBalancesData getBankFixedIncomesBalancesData() {
        return new ResponseBankFixedIncomesBalancesData()
                ...
                .updatedUnitPrice(new ResponseBankFixedIncomesBalancesDataUpdatedUnitPrice()
                ...
                .purchaseUnitPrice(new ResponseBankFixedIncomesBalancesDataPurchaseUnitPrice()
