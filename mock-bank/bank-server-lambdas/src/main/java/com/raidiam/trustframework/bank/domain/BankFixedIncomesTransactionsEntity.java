...
@Entity
@Audited
@Table(name = "bank_fixed_incomes_transactions")
public class BankFixedIncomesTransactionsEntity extends BaseEntity {
    ...
    private BankFixedIncomesEntity investment;

    public ResponseBankFixedIncomesTransactionsData getBankFixedIncomesTransactionData() {
        return new ResponseBankFixedIncomesTransactionsData()
                .type(EnumIncomeMovementType.fromValue(type))
                .transactionType(EnumBankFixedIncomeTransactionType.fromValue(transactionType))
                ...
                .incomeTax(new ResponseBankFixedIncomesTransactionsDataIncomeTax()
                        .amount(BankLambdaUtils.doubleToString(incomeTaxValue))
                        .currency(incomeTaxCurrency))
                .financialTransactionTax(new ResponseBankFixedIncomesTransactionsDataFinancialTransactionTax()
