...
public class PermissionGroups {
    ...
    public static final Set<Set<CreateConsentData.PermissionsEnum>> BUSINESS_PERMISSION_GROUPS = initBusiness();

    public static final Set<Set<CreateConsentData.PermissionsEnum>> PERSONAL_PERMISSION_GROUPS = initPersonal();
    ...
    private static Set<Set<CreateConsentData.PermissionsEnum>> initPersonal() {
        Set<CreateConsentData.PermissionsEnum> personalRegistrationData =
    ...
    private static Set<Set<CreateConsentData.PermissionsEnum>> initBusiness() {
        Set<CreateConsentData.PermissionsEnum> businessRegistrationData =
