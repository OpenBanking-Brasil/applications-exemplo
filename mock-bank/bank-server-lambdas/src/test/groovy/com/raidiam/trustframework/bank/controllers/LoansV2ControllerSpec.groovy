...
@Testcontainers
class LoansV2ControllerSpec extends FullCreateConsentFactory {
    @Shared
    String getToken
    @Shared
    String contractId
    @Shared
    EnumContractType type = EnumContractType.LOAN
    @Shared
    ContractTypeEnum pathType = ContractTypeEnum.LOAN
    @Shared
