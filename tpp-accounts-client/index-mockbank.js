    ...
    app.post('/cb', async (req, res) => {
        ...
        if (!Object.keys(callbackParams).length) {
            ...
            const createPost = await consentsApi.consentsPostConsents(`${tokens.token_type} ${tokens.access_token}`,
                {
                    data: {
                        permissions: [CreateConsentDataPermissionsEnum.AccountsRead, CreateConsentDataPermissionsEnum.AccountsBalancesRead, CreateConsentDataPermissionsEnum.ResourcesRead ],
