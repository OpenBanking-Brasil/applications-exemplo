...
<v-app-bar
    ...
    <v-btn
      ...
      >
        ...
        <span class="mr-2"><router-link to="/">Go to Home</router-link></span>
      ...
      >
        ...
        <span class="mr-2"><router-link to="/banks">Banks</router-link></span>
        <v-icon>mdi-open-in-new</v-icon>
      </v-btn>
      <v-btn
        target="_blank"
      ...
      >
        ...
        <span class="mr-2"><router-link to="/payment-menu">Payments</router-link></span>
        <v-icon>mdi-open-in-new</v-icon>
      </v-btn>
