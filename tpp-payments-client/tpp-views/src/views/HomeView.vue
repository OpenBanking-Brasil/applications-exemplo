                      ...
                      <v-container>
                        <v-row>
                          ...
                          <v-col cols="12" sm="4" md="4">
                            ...
                            <v-icon small title="The type of JSON Web Key Set (JWKS) algorithm that must be used for signing request objects.">
                              mdi-information
                            </v-icon>
                            <v-text-field
                              placeholder="PS256"
                          ...
                          <v-col cols="12" sm="4" md="4">
                            ...
                            <v-icon small title="JWS algorithm used for signing authorization responses."> mdi-information </v-icon>
                            <v-text-field
                              placeholder=""
                              outlined
                              dense
                          ...
                          <v-col cols="12" sm="4" md="4">
                            <b> Signing Key ID </b>
                            <v-icon small title="Signing key ID used for signing JWT"> mdi-information </v-icon>
                            <v-text-field
                              placeholder=""
                              outlined
                              dense
